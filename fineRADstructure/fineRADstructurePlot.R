...
plotsFolder <- "/Users/nicolepittoors/Documents/Documents - biscaya/Research/Swiftia_PopGen2/figures/"
...
source("/Users/nicolepittoors/Documents/Documents - biscaya/Research/Swiftia_PopGen2/fineRADstructure/FinestructureLibrary.R", chdir = TRUE) # read in the R functions, which also calls the needed packages
